...
//import static objects.Person.getModulesList;

public class CAPlist {
//    private final ArrayList<Module> bobModuleList = getModulesList();
//    private final ArrayList<Module> bobModuleList = new ArrayList<>();
...
//        for (CAP cap : CAPlist) {
//            if (cap.getCAP() > 0) {
//                totalAcademicPoints += cap.getCAP() * cap.getCurrentMC();
//            }
//        }
...
//        for (CAP cap : CAPlist) {
//            if (cap.getCAP() > 0) {
//                totalModuleCredit += cap.getCurrentMC();
//            }
//        }
//        return totalModuleCredit;
//    }

    public CAPlist(Person currentPerson) {
...
//                setSUs();
     ...
     */
    //Automatically done inside acad planner to allow for o(1) efficiency
...
//            currentCAP.setCurrentMC(Integer.parseInt(in.nextLine()));
//
//            CAPlist.clear();
//            CAPlist.add(currentCAP);
...
//            CAP targetCAP = new CAP(0.00,0);
            ...
            int targerGradedMC = Integer.parseInt(in.nextLine());

            calculateResults(targetCAP, targerGradedMC);
        } catch(NullPointerException e) {
            System.out.println(ERROR_INVALID_COMMAND);
            System.out.println(AWAIT_COMMAND);
//        } catch (IllegalCAPException e) {
